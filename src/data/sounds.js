// SoundTrend — Mock Sound Data
// 32 entries: ~60% TikTok, ~40% Instagram, spread of commercial statuses
...
// Assign stable clip index to each sound at load time
SOUNDS.forEach((s, i) => { s.clipIndex = i % PREVIEW_CLIPS.length; });
